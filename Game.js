...
BunnyDefender.Game.prototype = {
    ...
    buildBunnies: function() {
        ...
        for(var i=0; i<this.totalBunnies; i++) {
            var b = this.bunnygroup.create(this.rnd.integerInRange(-10, this.world.width-50), 
                this.rnd.integerInRange(this.world.height-180, 
                this.world.height-60), 'bunny', 'Bunny0000');
    ...
    buildSpaceRocks: function() {
        ...
        for(var i=0; i<this.totalSpacerocks; i++) {
            ...
            var scale = this.rnd.realInRange(0.3, 1.5);
            r.scale.x = scale;
            r.scale.y = scale;
    ...
    buildEmitter:function() {
        ...
        this.input.onTap.add(this.fireBurst, this);
    },
    ...
    fireBurst: function(pointer) {
        if(this.gameover == false){
            ...
            this.burst.start(true, 2000, null, 15); //(explode, lifespan, frequency, quantity)
        }
    },
